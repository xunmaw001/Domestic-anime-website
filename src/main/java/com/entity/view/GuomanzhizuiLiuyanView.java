...
public class GuomanzhizuiLiuyanView extends GuomanzhizuiLiuyanEntity implements Serializable {
	...
	public GuomanzhizuiLiuyanView() {

	}

	public GuomanzhizuiLiuyanView(GuomanzhizuiLiuyanEntity guomanzhizuiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, guomanzhizuiLiuyanEntity);

...
var centerMenu = [
    ...
    ,{
        name: '国漫先驱收藏',
        url: '../dongmanCollection/list.html'
    }
    ,{
        name: '国漫先驱留言',
        url: '../dongmanLiuyan/list.html'
    }
    ,{
        name: '国漫之最收藏',
        url: '../guomanzhizuiCollection/list.html'
    }
    ,{
        name: '国漫之最留言',
        url: '../guomanzhizuiLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '国漫之最',
        url: './pages/guomanzhizui/list.html'
    },
    {
        name: '历史沿革',
        url: './pages/lishiyange/list.html'
    },
    {
        name: '公告信息',
    ...
    {
        name: '知识窗',
        url: './pages/zhishuchang/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/guocnadongmanwanzan/admin/dist/index.html#/login";
